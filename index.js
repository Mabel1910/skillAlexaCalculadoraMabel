...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Bienvenido, a la Calculadora UTHH';
...
const SumaIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        const cantidadadd = handlerInput.requestEnvelope.request.intent.slots.numDos.value;
...
const MultiplicacionIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        let resultado = 0;
        resultado = numero1 * numero2;
        const speakOutput = `Calculadora UTH... El resultado de la multiplicacion de ${numero1} por ${numero2} es igual a ${resultado}.`;
        return handlerInput.responseBuilder
            .speak(speakOutput)
            //.reprompt('add a reprompt if you want to keep the session open for the user to respond')
            .getResponse();
...
const DivisionIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        let resultado = 0;
        resultado = numero1 / numero2;
        const speakOutput = `Calculadora UTH... El resultado de la division de ${numero1} entre ${numero2} es igual a ${resultado}.`;
        return handlerInput.responseBuilder
            .speak(speakOutput)
            //.reprompt('add a reprompt if you want to keep the session open for the user to respond')
            .getResponse();
...
const CosenoIntentHandler = {
    ...
    handle(handlerInput) {
        const requestAttributes = handlerInput.attributesManager.getRequestAttributes();
        const angulo = handlerInput.requestEnvelope.request.intent.slots.numeroUno.value;
        ...
        let resultado = Math.cos(numeroAngulo * Math.PI / 180); // Convertir de grados a radianes
        const speakOutput = `Calculadora UTH... El coseno de ${numeroAngulo} es igual a ${resultado}.`;
        return handlerInput.responseBuilder
            .speak(speakOutput)
            .getResponse();
    }
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Puedes decirme hola! Como puedo ayudarte?';
...
exports.handler = Alexa.SkillBuilders.custom()
    ...
    .addErrorHandlers(
        ErrorHandler)
    .withCustomUserAgent('sample/Calculadora/v1.2')
    .lambda();